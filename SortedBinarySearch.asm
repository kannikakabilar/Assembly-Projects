	.data
amount_num: 		.asciiz 	"How many total numbers do you have? "
num: 			.asciiz 	"Enter a number: "
nl: 			.asciiz 	"\n"
array_contains: 	.asciiz 	"\nThe array contains the following: \n"
sorted_array_contains: 	.asciiz 	"\nThe sorted array contains the following: \n"
complete: 		.asciiz 	"\nprogram complete"
.align 2
array: 			.space		 40
...
main:
	...
	contents_msg(sorted_array_contains)
