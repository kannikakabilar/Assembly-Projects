...
; Initialize the number of days passed for each month
.DATA
jan         equ  0
feb         equ  jan + 31
mar         equ  feb + 28
...
; Initalize other values that will assist in calculating
...
;======================================================================
; Main 
; Perform day calculation traversing through the branches accordingly
;======================================================================
  Main PROC
      mov     ax,     @data
      mov     ds,     ax
