	.data
ask_msg: 		.asciiz 	"Enter a Number (enter 0 to exit): "
sum_msg: 		.asciiz 	"\nThe total sum is: "
num_entered_msg:	.asciiz 	" numbers were entered\n"
nl: 			.asciiz 	"\n"
average_msg: 		.asciiz 	"\nThe average is: "
decimal: 		.asciiz 	"."
complete: 		.asciiz 	"\nProgram Exited"
...
main:				# Loops until the user inputs a zero.
	la $a0, ask_msg 	# Loads the address of ask_msg into the argument register.
...
calc_average:			# Calculate the average.
	...
	mult $t4, $t3		# Multiply the remainder by 1000. 
				# Because we'll later attach it as a decimal value to the nearest thousandths
...
results:			# Print the results.
	la $a0, sum_msg	# Loads the address of sum_mess into the argument register.
	li $v0, 4		# System call code to print a string.
	...
	la $a0, num_entered_msg # Loads the address of num_entered_mess into the argument register.
	li $v0, 4		# System call code to print a string.
	syscall			# Prints num_entered_mess.
	
	la $a0, average_msg	# Loads the address of average_mess into the argument register.
	li $v0, 4		# System call code to print a string.
...
exit:	
	...
	li $v0, 10		# System call code to exit the program gracefully.
