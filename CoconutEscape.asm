...
# Kannika Kabilar
#
# How to play the Assembly version of DoodleJump:
# 1. Start Mars, open this file, click Tools at the top left 
# 2. Open the bitmap display and the keyboard disaply and mmio simulator
# 3. Select connect to MIPS for both displays
# 4. Press 's' to start and stop the game; 'j' to move left; 'r' to move left
